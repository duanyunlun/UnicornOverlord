...
internal static class ModModuleCatalog
{
	...
	[
		...
		new() { Project = project, Key = "experience_scale", Category = "战斗", Name = "战斗经验倍率", Description = "调整战斗获得的经验，不改变经验书和道具。仅启用一份经验倍率补丁。", IsAvailable = true, CalibrationState = "上游欧美版模板", Warning = "仅支持欧美版 v1.0.5；亚洲版代码洞未校准，禁止导出。未经过本地游戏运行验证。" },
		new() { Project = project, Key = "enemy_level_scale", Category = "战斗", Name = "敌军动态等级", Description = "根据玩家队伍等级动态调整关卡与遭遇等级，保留上游的关卡下限与试炼例外。", IsAvailable = true, CalibrationState = "上游欧美版模板", Warning = "仅支持欧美版 v1.0.5；亚洲版禁止导出。代码洞可能与其他运行时 MOD 冲突，需备份存档并验证。" },
		...
		new() { Project = project, Key = "mission_editor", Category = "编队", Name = "关卡编队与战术", Description = "按任务选择队伍和成员，编辑站位、角色模板、装备及战术预设。预设 0 使用职业与装备默认技能；非零预设仅使用指定列表。", IsAvailable = true, CalibrationState = "原版表静态校准", Warning = "共享装备和战术会影响其他引用者；未经过游戏内验证。职业默认条件和默认装备表在原有职业编辑器中。" },
	...
	public static IReadOnlyList<ModCategory> CreateCategories(IReadOnlyList<ModModule> modules)
	{
		...
		[
			...
			new("战斗", [Find("battle_preview"), Find("battle_timer_freeze"), Find("unlimited_battle_start"), Find("type_matchups"), Find("experience_scale"), Find("enemy_level_scale")]),
			...
			new("编队", [Find("six_member_units"), Find("mission_editor")]),
