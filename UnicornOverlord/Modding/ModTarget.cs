...
internal sealed record ModTarget(String Key, String Name, String GameVersion, String TitleId, String BuildId) : INotifyPropertyChanged
{
	...
	{
		foreach (ModTarget target in All)
			target.PropertyChanged?.Invoke(target, new PropertyChangedEventArgs(nameof(DisplayName)));
	}
}
