...
internal class ViewModel : INotifyPropertyChanged
{
	...
	internal static ObservableCollection<ModModule> CreateModModules()
	{
		return
		[
			new() { Key = "ability_editor", Category = "技能", NavigationCategoryHeader = "技能", Name = "技能编辑器", Description = "从 441 个已校准技能中选择主动或被动技能，修改其 AP/PP 消耗、威力、命中、目标范围和首个效果参数。技能类型由游戏数据决定，不能手动互换。", IsAvailable = true, CalibrationState = "441 个技能已校准", RecordId = 372 },
			new() { Key = "battle_preview", Category = "战斗", NavigationCategoryHeader = "战斗", Name = "战斗预览调整", Description = "“不完美预览”用 5 次模拟的平均值展示大致趋势；“完全隐藏”则移除整个预览条。", IsAvailable = true, CalibrationState = "亚洲版已重定位", TemplateFile = "battle_preview_hidden.pchtxt", RecordId = 0 },
			...
			new() { Key = "character_randomizer", Category = "角色", NavigationCategoryHeader = "角色", Name = "角色加入随机化", Description = "随机改变教程五人以外的 63 名剧情角色加入顺序；过场、地图事件和能力触发时点不变。", IsAvailable = true, CalibrationState = "亚洲版已重定位", TemplateFile = "character_randomizer_base.pchtxt", ValueA = 20260826, Warning = "实验性功能：只用于新游戏，全流程保持启用并备份存档；中途移除可能使剧情读取不同步。" },
			new() { Key = "class_editor", Category = "职业", NavigationCategoryHeader = "职业", Name = "职业编辑器", Description = "按职业名称修改 73 个职业的十项成长率、AP/PP，以及 4 个主动和 4 个被动技能及习得等级。", IsAvailable = true, CalibrationState = "73 个职业字段已校准", RecordId = 1 },
			new() { Key = "fort_editor", Category = "据点", NavigationCategoryHeader = "据点", Name = "据点雇佣编辑器", Description = "按 63 个具体据点选择全部 248 个招募位置并修改可招募职业；选择后会载入原版职业，手动选择不受转职阶段限制。", IsAvailable = true, CalibrationState = "63 个据点 / 248 项已校准", RecordId = 1, Warning = "仅写职业字段，亚洲版记录中的性别与附加类型保持不变。" },
			new() { Key = "mine_editor", Category = "采矿", NavigationCategoryHeader = "采矿", Name = "采矿掉落编辑器", Description = "按五个地区采掘场选择 63 条具体原版掉落，修改物品、相对权重、挖掘目标和单局上限。", IsAvailable = true, CalibrationState = "5 个采掘场 / 63 项已校准", RecordId = 0, Warning = "藏宝图等一次性物品由游戏另行限制；提高权重时也要检查单局上限。" },
			new() { Key = "shop_editor", Category = "商店", NavigationCategoryHeader = "商店", Name = "商店库存编辑器", Description = "按科尔尼亚的具体地图地点选择武具店和原版商品，修改商品、库存与金币价格；共享库存会明确标识。", IsAvailable = true, CalibrationState = "25 个武具店 / 211 个地点条目已校准", RecordId = 0, Warning = "当前接入科尔尼亚普通武具店；兑换所价格结构不同，不会错误套用金币价格。" },
			new() { Key = "six_member_units", Category = "编队", NavigationCategoryHeader = "编队", Name = "六人编队", Description = "允许 S 级声望下将部队扩充至六人，并可设置荣誉费用。", IsAvailable = true, CalibrationState = "亚洲版已重定位", TemplateFile = "six_member_units.pchtxt", ValueA = 500, Warning = "卸载前必须先撤下所有部队的第六名成员。" },
			new() { Key = "text_editor", Category = "文本", NavigationCategoryHeader = "文本", Name = "文本编辑器", Description = "基于所选语言 CPK 的原始 FMS 按索引修改文本，不改动源归档。", IsAvailable = true, CalibrationState = "CPK 文本表编辑" },
		];
	}
