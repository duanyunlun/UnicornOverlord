...
internal class ViewModel : INotifyPropertyChanged
{
	...
	internal static ObservableCollection<ModModule> CreateModModules()
	{
		...
		[
			...
			new() { Key = "mine_editor", Category = "采矿", Name = "采矿掉落编辑器", Description = "按五个地区采掘场选择 63 条具体原版掉落，修改物品、相对权重、挖掘目标和单局上限。", IsAvailable = true, CalibrationState = "5 个采掘场 / 63 项已校准", RecordId = 0, Warning = "藏宝图等一次性物品由游戏另行限制；提高权重时也要检查单局上限。" },
